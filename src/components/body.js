                ...
                <Grid item xs={6}>
                    <Grid xs={12} className={classes.siteSesion}>
                        ...
                        <Image
                            ...
                            alt="Logo"
                        />
                        <form onSubmit={handleSubmit(onSubmit)} className={classes.formplace}>
                        <Divider className={classes.dividerTransparent} />
                            <Controller
                                name="email"
                                control={control}
                                defaultValue=""
                                render={({ field }) => <TextField {...field} className={classes.colortextfield} label="Correo electrónico" variant="filled" type="email" />}
                            ...
                            <Controller
                                ...
                                control={control}
                                defaultValue=""
                                render={({ field }) => <TextField {...field} className={classes.colortextfield} label="Contraseña" variant="filled" type="password" />}
                            />
                            <Divider className={classes.dividerTransparent} />

                            <Button type="submit" variant="contained" color="white" href="/chats" >Iniciar Sesión</Button>
                            
                            <div className={classes.sentence}>
                                <p>¿No tienes cuenta? <Button className={classes.colorp} onClick={handleOpen}>
                                    Registrate
                                </Button>
                                    <Modal
                                        open={open}
                ...
                <Grid item xs={12}>
                    <Box >
                        <div className={classes.second}>
                            <h1 className={classes.titles}>!Conoce personas a solo un click!</h1>
                ...
                <Grid item xs={4}>
                    <Box className={classes.Box}>
                        <Image
                            ...
                            alt="chat"
                        />
                        <p>Conoce a mas personas creando chats aleatorios con estudiantes de la EPN.</p>
                    </Box>
                </Grid>
                <Grid item xs={4}>
                    <Box className={classes.Box}>
                        <Image
                            ...
                            alt="mulimedia"
                        />
                        <p>Envía imagenes y videos a todos tus chats haciendo más interactiva tu comunicación.</p>
                    </Box>
                </Grid>
                <Grid item xs={4}>
                    <Box className={classes.Box}>
                        <Image
                            ...
                            alt="gruop"
                        />
                        <p>Comparte tus intereses con los demas usuariosy crea tu propia lista de amigos</p>
                    </Box>
                </Grid>
            </Grid>
            ...
            <Grid container spacing={0} className={classes.grid}>
                <Grid item xs={12}>
                    <Box className={classes.Box}>
                        ...
                        <FacebookIcon className={classes.icons} fontSize="large"></FacebookIcon>
                        <MailIcon className={classes.icons} fontSize="large"></MailIcon>
                        <SchoolIcon className={classes.icons} fontSize="large"></SchoolIcon>
                        <WhatsAppIcon className={classes.icons} fontSize="large"></WhatsAppIcon>
